...
RotEncoder::RotEncoder(const int pin, const float wheel_d, const int num_of_encs,
...
volatile word RotEncoder::count() {
	rotations  = _tickcount / _encs;
	return rotations;
}

// Returns distance in meters.
float RotEncoder::distance() {
